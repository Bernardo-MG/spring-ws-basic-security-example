...
package com.bernardomg.example.ws.security.basic.test.security.login.service.unit;
...
import com.bernardomg.example.ws.security.basic.security.login.model.TokenLoginStatus;
...
public class TestTokenLoginServiceUserStatus {
    ...
    private final TokenLoginService getService(final UserDetails user) {
        ...
        Mockito.when(tokenProvider.generateToken(ArgumentMatchers.anyString(), ArgumentMatchers.anyString()))
            .thenReturn("token");
