...
package com.bernardomg.example.ws.security.basic.test.auth.login.validation.integration;
...
@IntegrationTest
@DisplayName("ValidUserNameAndPasswordLoginValidator")
...
public class ITValidUserNameAndPasswordLoginValidator {

    private final LoginValidator validator;

    @Autowired
    public ITValidUserNameAndPasswordLoginValidator(final UserDetailsService userDetsService,
            final PasswordEncoder passEncoder) {
        super();

        validator = new ValidUserNameAndPasswordLoginValidator(userDetsService, passEncoder);
    }
